...
summary: BlueXP를 사용하여 AWS의 데이터 및 스토리지 인프라를 관리할 수 있도록 AWS 권한을 설정합니다. 사용 권한을 설정하는 방법은 사용하려는 설치 옵션에 따라 다릅니다. 
---
= AWS 권한을 설정합니다
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
BlueXP를 사용하여 AWS의 데이터 및 스토리지 인프라를 관리할 수 있도록 AWS 권한을 설정합니다. 사용 권한을 설정하는 방법은 사용하려는 설치 옵션에 따라 다릅니다.
...
TIP: BlueXP에서 Connector를 만들면 Connector to AWS 리소스를 활성화하는 Connector 인스턴스에 새 권한 집합이 적용됩니다.
