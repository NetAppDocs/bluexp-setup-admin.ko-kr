...
| "Microsoft.Network/privateEndpoints/delete"," Microsoft.Compute/availabilitySets/delete", | 배포 실패 또는 삭제 시 BlueXP에서 Cloud Volumes ONTAP에 속한 리소스 그룹에서 리소스를 제거할 수 있습니다. 
