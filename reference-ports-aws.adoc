...
| TCP | 9060 | 정부 클라우드 구축 환경에서 Cloud Data Sense 및 Cloud Backup을 활성화하고 사용할 수 있는 기능을 제공합니다. Cloud Manager 계정에서 SaaS 인터페이스를 사용하지 않도록 설정하는 경우 Cloud Backup에도 이 포트가 필요합니다. 
|===
