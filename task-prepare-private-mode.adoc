...
summary: 환경을 준비할 수 있도록 BlueXP를 개인 모드에서 시작하고 실행하는 데 필요한 사항을 이해해야 합니다. 
---
= 프라이빗 모드로 구축을 준비합니다
:hardbreaks:
:allow-uri-read: 
