...
[role="lead"]
자신의 Linux 호스트에 Connector를 수동으로 설치하려면 호스트 요구 사항을 검토하고 네트워킹을 설정하고 Azure 사용 권한을 준비하고 커넥터를 설치한 다음 준비한 사용 권한을 제공해야 합니다.
...
* CentOS 7.6 - 7.9
+
NetApp는 2024년 6월 30일까지 CentOS 7과 함께 커넥터를 계속 지원할 예정입니다.

* Red Hat Enterprise Linux
+
** 7.6 - 7.9
+
NetApp는 2024년 6월 30일까지 RHEL 7과 함께 커넥터를 계속 지원할 예정입니다.
...
+
--
https://access.redhat.com/articles/973163["Red Hat 솔루션: Red Hat Enterprise Linux 실행 인증을 받은 하이퍼바이저는 무엇입니까?"^]
...
* Ubuntu, CentOS 및 Red Hat Enterprise Linux 7에는 Docker 엔진이 필요합니다.
+
** 지원되는 최소 버전은 19.3.1입니다.
...
.Docker 엔진
--
19.3.1과 25.0.5 사이에 Docker 엔진 버전을 설치합니다.
