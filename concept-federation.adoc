...
summary: ID 페더레이션을 사용하면 BlueXP에서 SSO를 사용할 수 있으므로 사용자는 기업 ID의 자격 증명을 사용하여 로그인할 수 있습니다. ID 공급자와의 연결을 설정하기 전에 BlueXP에서 ID 페더레이션을 지원하는 방법을 이해해야 합니다. 
---
...
[role="lead"]
ID 페더레이션을 사용하면 BlueXP에서 SSO를 사용할 수 있으므로 사용자는 기업 ID의 자격 증명을 사용하여 로그인할 수 있습니다. ID 공급자와의 연결을 설정하기 전에 BlueXP에서 ID 페더레이션을 지원하는 방법을 이해해야 합니다.
