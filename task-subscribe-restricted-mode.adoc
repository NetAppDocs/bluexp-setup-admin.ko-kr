...
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-adding-aws-accounts.html["BlueXP에 대한 AWS 자격 증명 및 구독을 관리합니다"]
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-adding-azure-accounts.html["BlueXP용 Azure 자격 증명 및 구독을 관리합니다"]
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-adding-gcp-accounts.html["BlueXP용 Google Cloud 자격 증명 및 구독을 관리합니다"]
