...
====
.관련 링크
* https://["Cloud Volumes ONTAP용 BYOL 용량 기반 라이센스 관리"^]
* https://["BlueXP 데이터 서비스에 대한 BYOL 라이센스 관리"^]
* https://["BlueXP에 대한 AWS 자격 증명 및 구독을 관리합니다"]
* https://["BlueXP용 Azure 자격 증명 및 구독을 관리합니다"]
* https://["BlueXP용 Google Cloud 자격 증명 및 구독을 관리합니다"]
