...
summary: BlueXP 웹 기반 콘솔에서 또는 gcloud를 사용하거나 자체 Linux 호스트에 소프트웨어를 설치하여 커넥터를 직접 만듭니다. 
---
...
[role="lead"]
BlueXP 웹 기반 콘솔에서 또는 gcloud를 사용하거나 자체 Linux 호스트에 소프트웨어를 설치하여 커넥터를 직접 만듭니다.
