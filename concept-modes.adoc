...
| 백업 및 복구 | AWS 및 Azure 상용 지역에서 지원됩니다. Google Cloud 또는 에서는 지원되지 않습니다 https://aws.amazon.com/federal/us-intelligence-community/["AWS C2S/SC2S"^] 또는 https://learn.microsoft.com/en-us/azure/compliance/offerings/offering-dod-il6["Azure iL6"^] 
...
| 백업 및 복구 | 사내 ONTAP 볼륨을 StorageGRID 시스템에 대해서만 백업 및 복원을 지원합니다.https://docs.netapp.com/us-en/cloud-manager-backup-restore/task-backup-onprem-private-cloud.html["사내 ONTAP 데이터를 StorageGRID에 백업하는 방법을 알아보십시오"^] 
...
https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-manage-node-licenses.html#add-unassigned-licenses["BlueXP 디지털 지갑에 라이센스를 추가하는 방법에 대해 알아봅니다"^]
