...
Google Cloud 또는 에서는 지원되지 않습니다 https://aws.amazon.com/federal/us-intelligence-community/["AWS C2S/SC2S"^] 또는 https://learn.microsoft.com/en-us/azure/compliance/offerings/offering-dod-il6["Azure iL6"^] 
...
| 백업 및 복구 | 사내 ONTAP 볼륨을 StorageGRID 시스템에 대해서만 백업 및 복원을 지원합니다.
