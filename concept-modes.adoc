...
애플리케이션, 가상 시스템 및 Kubernetes는 지원되지 않습니다. 
...
| 백업 및 복구  a| 
* 온프레미스 ONTAP 볼륨을 StorageGRID 시스템에 백업 및 복원할 수 있습니다.
+
https://docs.netapp.com/us-en/bluexp-backup-recovery/task-backup-onprem-private-cloud.html["사내 ONTAP 데이터를 StorageGRID에 백업하는 방법을 알아보십시오"^]

* 온프레미스 ONTAP 볼륨을 ONTAP S3에 백업하고 복원할 수도 있습니다.
+
https://docs.netapp.com/us-en/bluexp-backup-recovery/task-backup-onprem-to-ontap-s3.html["온프레미스 ONTAP 데이터를 ONTAP S3에 백업하는 방법에 대해 알아보십시오"^]
