...
+
--
보안 영역에는 다음이 포함됩니다 https://aws.amazon.com/federal/us-intelligence-community/["AWS C2S 및 SC2S"^] 및 https://learn.microsoft.com/en-us/azure/compliance/offerings/offering-dod-il6["Azure iL6"^]
...
| 클라우드 백업 | 제한 모드가 있는 정부 지역 및 상업 지역에서 지원됩니다. 제한된 모드의 주권 지역에서는 지원되지 않습니다. 애플리케이션, 가상 시스템 및 Kubernetes는 지원되지 않습니다. 
...
| 디지털 지갑 | 제한된 모드에 대해 아래에 나열된 지원되는 라이센스 옵션이 있는 Digital Wallet을 사용할 수 있습니다. 
...
| 클라우드 백업 | AWS 및 Azure 상용 지역에서 지원됩니다. Google Cloud 또는 에서는 지원되지 않습니다 https://aws.amazon.com/federal/us-intelligence-community/["AWS C2S/SC2S"^] 또는 https://learn.microsoft.com/en-us/azure/compliance/offerings/offering-dod-il6["Azure iL6"^] 


| Cloud Volumes ONTAP | 인터넷에 액세스할 수 없으므로 자동화된 소프트웨어 업그레이드, AutoSupport 및 AWS 비용 정보와 같은 기능을 사용할 수 없습니다. 


| 디지털 지갑 | 개인 모드에 대해 아래에 나열된 지원되는 라이선스 옵션과 함께 Digital Wallet을 사용할 수 있습니다. 
...
| 클라우드 백업 | 사내 ONTAP 볼륨을 StorageGRID 시스템에 대해서만 백업 및 복원을 지원합니다.https://docs.netapp.com/us-en/cloud-manager-backup-restore/task-backup-onprem-private-cloud.html["사내 ONTAP 데이터를 StorageGRID에 백업하는 방법을 알아보십시오"^] 


| 클라우드 데이터 감지  a| 
* 지원되는 데이터 원본은 로컬에서 검색할 수 있는 원본뿐입니다.
+
https://docs.netapp.com/us-en/cloud-manager-data-sense/task-deploy-compliance-dark-site.html#supported-data-sources["로컬로 검색할 수 있는 소스를 봅니다"^]

* 아웃바운드 인터넷 액세스가 필요한 기능은 지원되지 않습니다.
+
https://docs.netapp.com/us-en/cloud-manager-data-sense/task-deploy-compliance-dark-site.html#limitations["기능 제한 사항을 봅니다"^]
...
+
--
Cloud Volumes ONTAP BYOL의 경우 노드 기반 라이센스만 지원됩니다. 용량 기반 라이센스는 지원되지 않습니다. 아웃바운드 인터넷 연결을 사용할 수 없으므로 디지털 지갑에서 Cloud Volumes ONTAP 라이선스 파일을 수동으로 업로드해야 합니다.

https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-manage-node-licenses.html#add-unassigned-licenses["디지털 지갑에 라이선스를 추가하는 방법을 알아보십시오"^]
...
[cols="33h,33,33"]
|===
| BlueXP 서비스 또는 기능 | 제한된 모드 | 비공개 모드 


| ONTAP용 Amazon FSx | 예 | 아니요 


| Amazon S3 | 아니요 | 아니요 


| AppTemplate(애플리케이션 템플릿) | 아니요 | 아니요 
