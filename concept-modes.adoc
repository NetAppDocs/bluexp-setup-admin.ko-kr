...
[role="lead"]
BlueXP 비즈니스 및 보안 요구 사항을 충족할 수 있는 _배포 모드_를 제공합니다.  _표준 모드_는 SaaS(Software as a Service) 계층을 활용하여 모든 기능을 제공하는 반면, _제한 모드_와 _개인 모드_는 연결 제한이 있는 조직에서 사용할 수 있습니다.
...
| 백업 및 복구 | 제한 모드가 적용된 정부 지역 및 상업 지역에서 지원됩니다. 제한 모드가 적용된 주권 지역에서는 지원되지 않습니다. 제한 모드에서 BlueXP backup and recovery ONTAP 볼륨 데이터의 백업과 복원만 지원합니다. https://docs.netapp.com/us-en/bluexp-backup-recovery/prev-ontap-protect-journey.html#support-for-sites-with-limited-internet-connectivity["ONTAP 데이터에 대해 지원되는 백업 대상 목록을 봅니다"^] 제한 모드에서 BlueXP backup and recovery ONTAP 볼륨 데이터의 백업과 복원만 지원합니다. https://docs.netapp.com/us-en/bluexp-backup-recovery/prev-ontap-protect-journey.html#support-for-sites-with-limited-internet-connectivity["ONTAP 데이터에 대해 지원되는 백업 대상 목록을 봅니다"^] 애플리케이션 데이터와 가상 머신 데이터의 백업 및 복원은 지원되지 않습니다. 
...
| 백업 및 복구 | AWS 및 Azure 상업 지역에서 지원됩니다. Google Cloud 또는 다음에서 지원되지 않습니다. https://aws.amazon.com/federal/secret-cloud/["AWS 비밀 클라우드"^] , https://aws.amazon.com/federal/top-secret-cloud/["AWS Top Secret Cloud의 약어입니다"^] , 또는 https://learn.microsoft.com/en-us/azure/compliance/offerings/offering-dod-il6["Azure iL6"^] 개인 모드에서 BlueXP backup and recovery ONTAP 볼륨 데이터의 백업과 복원만 지원합니다. https://docs.netapp.com/us-en/bluexp-backup-recovery/prev-ontap-protect-journey.html#support-for-sites-with-no-internet-connectivity["ONTAP 데이터에 대해 지원되는 백업 대상 목록을 봅니다"^] 애플리케이션 데이터와 가상 머신 데이터의 백업 및 복원은 지원되지 않습니다. 
...
| 백업 및 복구  a| 
개인 모드에서 BlueXP backup and recovery ONTAP 볼륨 데이터의 백업과 복원만 지원합니다. https://docs.netapp.com/us-en/bluexp-backup-recovery/prev-ontap-protect-journey.html#support-for-sites-with-no-internet-connectivity["ONTAP 볼륨 데이터에 대해 지원되는 백업 대상 목록을 봅니다"^]
...
| 백업 및 복구 | 예https://docs.netapp.com/us-en/bluexp-backup-recovery/prev-ontap-protect-journey.html#support-for-sites-with-limited-internet-connectivityView[] ONTAP 볼륨 데이터에 대해 지원되는 백업 대상 목록^] | 예https://docs.netapp.com/us-en/bluexp-backup-recovery/prev-ontap-protect-journey.html#support-for-sites-with-no-internet-connectivity["ONTAP 볼륨 데이터에 대해 지원되는 백업 대상 목록을 봅니다"^] 
