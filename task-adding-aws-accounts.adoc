...
+
기존 Connector에 AWS 자격 증명을 추가하면 퍼블릭 클라우드 환경 내의 리소스 및 프로세스를 관리하는 데 필요한 권한이 제공됩니다. <<커넥터에 자격 증명을 추가합니다,Connector에 AWS 자격 증명을 추가하는 방법에 대해 알아보십시오>>.
...
. 계정 자격 증명 * 페이지에서 * 자격 증명 추가 * 를 클릭하고 마법사의 단계를 따릅니다.
+
...
.단계
. BlueXP 콘솔의 오른쪽 상단에서 설정 아이콘을 클릭하고 * 자격 증명 * 을 선택합니다.
. 계정 자격 증명 * 페이지에서 자격 증명 세트에 대한 작업 메뉴를 클릭한 다음 * 가입 연결 * 을 선택합니다.
+
...
.단계
. BlueXP 콘솔의 오른쪽 상단에서 설정 아이콘을 클릭하고 * 자격 증명 * 을 선택합니다.
. 계정 자격 증명 * 페이지에서 자격 증명 세트에 대한 작업 메뉴를 클릭한 다음 * 자격 증명 편집 * 을 선택합니다.
...
.단계
. BlueXP 콘솔의 오른쪽 상단에서 설정 아이콘을 클릭하고 * 자격 증명 * 을 선택합니다.
. 계정 자격 증명 * 페이지에서 자격 증명 세트에 대한 작업 메뉴를 클릭한 다음 * 자격 증명 삭제 * 를 선택합니다.
. 확인하려면 * 삭제 * 를 클릭합니다.
