...
에서 BlueXP를 사용하려는 경우 https://["AWS C2S(Commercial Cloud Services) 환경"^] 그런 다음 별도의 지침에 따라 해당 환경에서 시작해야 합니다. https://["AWS C2S 환경에서 Cloud Volumes ONTAP를 시작하는 방법에 대해 알아보십시오"^]
...
----
. 에서 Connector 소프트웨어를 다운로드합니다 https://["NetApp Support 사이트"^]
+
...
.단계
. 웹 브라우저를 열고 를 입력합니다 https://[] 여기서 _ipaddress_는 Connector를 설치한 Linux 호스트의 IP 주소입니다.
+
다음 화면이 나타납니다.
