...
+
link:task-prepare-restricted-mode.html#step-5-prepare-cloud-permissions["AWS 권한을 설정하는 방법에 대해 알아보십시오"]
...
+
link:task-prepare-restricted-mode.html#step-5-prepare-cloud-permissions["Azure 사용 권한을 설정하는 방법에 대해 알아봅니다"]
...
link:task-prepare-restricted-mode.html#step-5-prepare-cloud-permissions["클라우드 사용 권한을 준비하는 방법에 대해 알아봅니다"].
