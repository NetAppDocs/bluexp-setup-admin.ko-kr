...
summary: 제한된 모드에서 BlueXP를 사용하려면 Connector를 배포한 다음 Connector에서 실행 중인 사용자 인터페이스에 액세스하여 BlueXP를 설정해야 합니다. 
---
= 커넥터를 제한 모드로 전개합니다
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
제한된 모드에서 BlueXP를 사용하려면 Connector를 설치하고 Connector에서 실행 중인 사용자 인터페이스에 액세스하여 BlueXP를 설정한 다음 클라우드 권한을 제공해야 합니다.
