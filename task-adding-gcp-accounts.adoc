...
+
Google Cloud 구독은 사용자 로그인과 연결된 모든 NetApp 계정에 연결됩니다. 새 구독에 대한 액세스를 제한해야 하는 경우 Digital Wallet의 구독과 연결된 NetApp 계정을 관리할 수 있습니다. link:task-manage-subscriptions.html#manage-your-subscriptions["구독을 관리하는 방법에 대해 알아봅니다"].
