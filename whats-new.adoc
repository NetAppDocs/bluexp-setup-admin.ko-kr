...
+
https://["지원되는 영역의 전체 목록을 봅니다"^]

* 이 커넥터 릴리스에는 Cloud Volumes ONTAP의 향상된 기능이 포함되어 있습니다.
+
https://["Cloud Volumes ONTAP의 향상된 기능에 대해 알아보십시오"^]
...
https://["이러한 배포 모드에 대해 자세히 알아보십시오"].
...
+
https://["이메일 알림을 설정하는 방법에 대해 알아봅니다"].
...
+
https://["지원 사례를 관리하는 방법에 대해 알아보십시오"].
...
+
** https://["인터넷에 연결되지 않은 위치에 커넥터를 설치합니다"^]
** https://["커넥터의 BlueXP 콘솔에 액세스합니다"^]
** https://["할당되지 않은 라이센스를 추가합니다"^]
** https://["Cloud Volumes ONTAP를 시작하십시오"^]


* 이제 Connector를 사용하여 BlueXP에서 Amazon S3 버킷을 추가하고 관리할 수 있습니다.
+
https://["BlueXP에서 AWS 계정에 새 Amazon S3 버킷을 추가하는 방법을 알아보십시오"^].
...
+
** https://["AWS 구독을 연결하는 방법을 알아보십시오"]
** https://["Azure 구독을 연결하는 방법에 대해 알아봅니다"]
** https://["Google Cloud 구독을 연결하는 방법을 알아보십시오"]


* 이제 BlueXP에서 커넥터 전원이 14일 이상 꺼졌으면 알려 줍니다.
+
** https://["BlueXP 알림에 대해 알아보십시오"]
** https://["커넥터가 계속 작동하는 이유에 대해 알아보십시오"]
...
+
https://["Connector에 대한 Google Cloud 권한을 봅니다"].
...
* BlueXP 콘솔의 URL을 로 업데이트했습니다 https://[]
...
계정에 연결된 새로 고침 토큰이 3개월 후에 만료될 때 NetApp Support 사이트 계정과 연결된 자격 증명을 업데이트하라는 메시지가 Cloud Manager에 표시됩니다. https://["NSS 계정 관리 방법에 대해 알아봅니다"^]
...
+
https://["내 기회를 사용하여 ONTAP용 FSx를 찾는 방법에 대해 알아보십시오"^]
...
https://["다음은 Connector를 생성하는 데 사용되는 AWS IAM 역할 권한을 보여 주는 예입니다"].

또한 각 정책에 대한 링크를 제공하는 페이지도 만들었습니다. https://["Cloud Manager에 대한 사용 권한 요약을 봅니다"].
...
+
https://["계정의 작업 모니터링에 대해 자세히 알아보십시오"].
...
* 당사는 지원하는 OS를 통해 VM 인스턴스에서 Google Cloud의 Connector를 인증했습니다 https://["차폐된 VM 기능"^]
* 이 커넥터 릴리스에는 Cloud Volumes ONTAP의 향상된 기능도 포함되어 있습니다. https://["이러한 향상된 기능에 대해 알아보십시오"^]
...
+
https://["IAM 역할을 사용하여 커넥터를 생성하는 방법에 대해 알아봅니다"].
...
이 커넥터 릴리스에는 Cloud Volumes ONTAP의 향상된 기능이 포함되어 있습니다. https://["이러한 향상된 기능에 대해 알아보십시오"^]
...
* https://["NetApp에서 ID 관리를 위해 Microsoft Azure AD를 사용하는 방법에 대해 자세히 알아보십시오"^]
...
https://["Cloud Volumes ONTAP를 사용하여 AutoSupport를 확인하는 방법에 대해 자세히 알아보십시오"^]
