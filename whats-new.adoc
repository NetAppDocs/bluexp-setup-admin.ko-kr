...
summary: 'NetApp 계정, 커넥터, 클라우드 공급자 자격 증명 등과 같은 BlueXP(이전의 Cloud Manager) 관리 기능의 새로운 기능에 대해 알아보십시오.' 
---
= 새로운 기능
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
NetApp 계정, 커넥터, 클라우드 공급자 자격 증명 등과 같은 BlueXP(이전의 Cloud Manager) 관리 기능의 새로운 기능에 대해 알아보십시오.
...
https://docs.netapp.com/us-en/cloud-manager-setup-admin/reference-checklist-cm.html["필요한 끝점 목록을 봅니다"]
