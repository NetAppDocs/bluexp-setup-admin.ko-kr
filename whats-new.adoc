...
다음 권한을 포함하도록 Azure에 대한 커넥터 정책을 업데이트했습니다.
...
* https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/whats-new.html["가상 머신 확장 세트에 대한 Cloud Volumes ONTAP 지원에 대해 알아보십시오"^]
...
== NetApp Support 사이트 계정에 필요한 업데이트
...
=== Cloud Volumes ONTAP의 NSS 계정 변경
