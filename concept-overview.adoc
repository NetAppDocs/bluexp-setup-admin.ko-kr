...
+
--
* 설정 및 사용 https://["Cloud Volumes ONTAP"^] 클라우드 전반에서 효율적인 멀티 프로토콜 데이터 관리
* 클라우드 파일 스토리지 서비스 설정 및 사용:
+
** https://["Azure NetApp Files"^]
** https://["ONTAP용 Amazon FSx"^]
** https://["Google Cloud용 Cloud Volumes Service"^]


* 검색 및 관리 https://["높지 않습니다"^]:
+
** E-Series 시스템
** ONTAP 클러스터
** StorageGRID 시스템
...
* 데이터 오케스트레이션 및 보호 https://["Kubernetes 영구 데이터"^]
...
https://["BlueXP를 사용하여 조직에 도움을 주는 방법에 대해 자세히 알아보십시오"^]
...
BlueXP의 가격은 사용할 서비스에 따라 다릅니다. https://["BlueXP 가격에 대해 알아보십시오"^]
...
BlueXP는 을 통해 액세스할 수 있습니다 https://["웹 기반 콘솔"^] API를 사용해 보십시오. 이 SaaS 환경을 통해 최신 기능이 릴리스될 때 자동으로 액세스할 수 있으며 BlueXP 계정과 커넥터 간에 쉽게 전환할 수 있습니다.
