...
summary: 하나 이상의 AWS 계정에 대한 자격 증명을 관리할 수 있도록 BlueXP에서 AWS 자격 증명과 사용 권한을 사용하는 방법을 이해해야 합니다. 예를 들어, BlueXP에 AWS 자격 증명을 추가하는 방법을 배울 수 있습니다. 
---
= AWS 자격 증명 및 권한
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
하나 이상의 AWS 계정에 대한 자격 증명을 관리할 수 있도록 BlueXP에서 AWS 자격 증명과 사용 권한을 사용하는 방법을 이해해야 합니다. 예를 들어, BlueXP에 AWS 자격 증명을 추가하는 방법을 배울 수 있습니다.
