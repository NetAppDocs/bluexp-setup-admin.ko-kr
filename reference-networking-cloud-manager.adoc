...
=== AutoSupport 메시지의 프록시 서버입니다

Cloud Volumes ONTAP에서 AutoSupport 메시지를 보내는 데 아웃바운드 인터넷 연결을 사용할 수 없는 경우 Cloud Manager는 자동으로 Cloud Volumes ONTAP를 구성하여 커넥터를 프록시 서버로 사용합니다.
