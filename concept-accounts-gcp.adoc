...
summary: BlueXP에서 Google Cloud 프로젝트의 자격 증명을 관리할 수 있도록 Google Cloud 자격 증명과 사용 권한을 사용하는 방법에 대해 알아보십시오. 예를 들어 Connector VM과 연결된 서비스 계정에 대해 자세히 알아볼 수 있습니다. 
---
...
[role="lead"]
BlueXP에서 Google Cloud 프로젝트의 자격 증명을 관리할 수 있도록 Google Cloud 자격 증명과 사용 권한을 사용하는 방법에 대해 알아보십시오. 예를 들어 Connector VM과 연결된 서비스 계정에 대해 자세히 알아볼 수 있습니다.
...
. 커넥터를 배포할 때 를 선택하라는 메시지가 나타납니다 https://cloud.google.com/iam/docs/service-accounts["서비스 계정"^] VM 인스턴스의 경우. BlueXP는 서비스 계정에서 권한을 받아 사용자를 대신하여 Cloud Volumes ONTAP 시스템을 생성 및 관리하는 등의 작업을 수행합니다. 권한은 서비스 계정에 사용자 지정 역할을 첨부하여 제공됩니다.
...
* https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-deploying-gcp.html["Google Cloud에서 Cloud Volumes ONTAP를 배포하고 프로젝트를 선택하는 방법에 대해 알아보십시오"^]
