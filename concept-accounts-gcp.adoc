...
summary: 하나 이상의 Google Cloud 프로젝트에 대한 자격 증명을 관리할 수 있도록 BlueXP에서 Google Cloud 자격 증명과 사용 권한을 사용하는 방법을 이해해야 합니다. 
---
...
[role="lead"]
하나 이상의 Google Cloud 프로젝트에 대한 자격 증명을 관리할 수 있도록 BlueXP에서 Google Cloud 자격 증명과 사용 권한을 사용하는 방법을 이해해야 합니다.
