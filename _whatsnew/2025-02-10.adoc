...
| 백업 및 복구 | 2025년 2월 5일 | 로 https://docs.netapp.com/us-en/bluexp-backup-recovery/whats-new.html["BlueXP  백업 및 복구 페이지의 새로운 기능"^] 이동하여 2025년 2월 릴리즈에 포함된 변경 사항을 참조하십시오. 
