...
[role="lead"]
Cloud Manager 계정 관리자는 대부분의 Cloud Manager 기능을 사용하기 전에 _Connector_를 배포해야 합니다. link:concept-connectors.html["커넥터가 필요한 시기를 알아보십시오"]. Connector를 사용하면 Cloud Manager에서 퍼블릭 클라우드 환경 내의 리소스와 프로세스를 관리할 수 있습니다.
...
.span class="image"><img src="https://raw.githubusercontent.com/NetAppDocs/common/main/media/number-4.png"[] Alt="4"></span> Google Cloud API를 활성화합니다
