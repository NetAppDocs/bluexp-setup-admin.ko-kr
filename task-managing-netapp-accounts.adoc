...
[role="lead"]
비공개 모드에서 BlueXP 를 사용하는 경우 _BlueXP  계정_ 을 사용하여 사용자를 관리하고 리소스를 구성할 수 있습니다. 계정을 만들 때는 관리자 한 명과 작업 영역만 포함됩니다. 사용자 추가, 자동화 목적으로 서비스 계정 생성, 작업 영역 추가 등을 통해 필요에 맞게 계정을 관리할 수 있습니다.
